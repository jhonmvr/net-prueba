...
import { ReNoticeService } from '../../core/services/generales/re-notice.service';
import { MatSnackBar, MatSnackBarConfig } from '@angular/material';
import { ReNotice } from '../../core/interfaces/re-notice';

/**
 * Componente para la presentacion de mensajes con componente snackbar
 */
@Component({
  selector: 'm-re-message',
  templateUrl: './re-message.component.html',
  styleUrls: ['./re-message.component.css']
})
